...
export default function Onboarding() {
  ...
  const { currentStep, totalSteps, data, updateData, nextStep, prevStep } = useOnboarding();
        ...
        <div className="flex justify-between mt-8">
          ...
          {currentStep < totalSteps ? (
            ...
            <Button 
              ...
              disabled={submitting}
              className="h-12 px-8 bg-accent hover:bg-accent/90 text-accent-foreground glow-accent"
            >
